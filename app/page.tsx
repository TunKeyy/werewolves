  ...
  const [gameState, setGameState] = useState<GameState>({
    ...
    availableRoles: [
      ...
      },
      {
        id: "lycan",
        name: "Lycan",
        description: "A normal villager. After being bitten by wolves, you become a wolf.",
        iconName: "ShieldOff",
      ...
      },
      {
        id: "wolf-cub",
        name: "Wolf Cub",
        description: "Wakes with the wolves. If killed, two people die the next night.",
        iconName: "Baby",
        icon: <Baby className="h-5 w-5" />,
        team: "werewolf",
        limit: 1,
      ...
      },
      {
        id: "moon-lady",
        name: "Moon Lady",
        description: "Pick one player each night. Choose wrongly and face death or mislead others.",
        iconName: "SunMoon",
        icon: <SunMoon className="h-5 w-5" />,
        team: "village",
        limit: 1,
      ...
      },
      {
        id: "silent-mage",
        name: "Silent Mage",
        description: "Pick one person each night. If they talk the next day, they die.",
        iconName: "MicOff",
      ...
      },
      {
        id: "witch",
        name: "Witch",
        description: "At night, you can save one person and kill one person.",
        iconName: "Flask",
        icon: <Flask className="h-5 w-5" />,
        team: "village",
        limit: 1,
      ...
      },
      {
        id: "foxxie",
        name: "Foxxie",
        description: "Each night, choose 3 people. If 1–2 are wolves, narrator will 'like'.",
        iconName: "Search",
      ...
      },
      {
        id: "bodyguard",
        name: "Bodyguard",
        description: "Protect 1 person. You may protect yourself, but not the same person two nights in a row.",
        iconName: "ShieldCheck",
        icon: <ShieldCheck className="h-5 w-5" />,
        team: "village",
        limit: 1,
      ...
      },
      {
        id: "thespian",
        name: "Thespian",
        description: "Each night, pick a random card from 3 and activate its effect.",
        iconName: "Sparkles",
      ...
      },
      {
        id: "alpha-wolf",
        name: "Alpha Wolf",
        description: "A wolf who can't be detected by the Seer. Makes the final decision for the wolves.",
        iconName: "Flame",
      ...
      },
      {
        id: "servant",
        name: "Servant",
        description: "When someone dies, you may reveal your role and take their role as your new identity.",
        iconName: "Repeat",
      ...
      },
      {
        id: "village-chief",
        name: "Village Chief",
        description: "The chief's vote counts as 2. Nominated by villagers. If the chief dies, they choose a successor.",
        iconName: "Crown",
        icon: <Crown className="h-5 w-5" />,
        team: "village",
        limit: 1,
      ...
      },
      {
        id: "knight",
        name: "Knight",
        description: "If bitten by wolves, the nearest wolf on your left dies with you.",
        iconName: "Sword",
        icon: <Sword className="h-5 w-5" />,
        team: "village",
        limit: 1,
      ...
      },
      {
        id: "ancient-shaman",
        name: "Ancient Shaman",
        description: "Choose 1 person nightly. If you die, they die instead. If they're already dead, you die.",
        iconName: "ScrollText",
